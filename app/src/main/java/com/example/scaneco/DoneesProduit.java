...
public class DoneesProduit {
    ...
    private final String[] tabRecyclable = {"Bouteille plastique", "Etui en carton", "Brique en carton", "Canette","Bouteille en PET",
            ...
            ,"Bouchon en plastique","Couvercle en métal", "Carton", "Opercule en papier", "Opercule en métal", "Sachet en papier", "Pot en carton",
            "Couvercle en carton", "Couvercle", "Boite en plastique", "Couvercle"};
